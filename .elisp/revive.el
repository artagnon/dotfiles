...
;;;
;;;	  ��������������������������������������������������������������
;;;	global ������ revive:save-variables-global-default ����local ��
;;;	���� revive:save-variables-local-default ����������������������
;;;	����������������������������revive:save-variables-global-private
;;;	�� global ����������revive:save-variables-local-private �� local
;;;	���������������������������������������������������� gmhist ������
;;;	����������������
;;;
;;;		(setq revive:save-variables-global-private
...
;;;		    ("����������������"	. trr)))
;;;
;;;	�������� revive:major-mode-command-alist-private ��������������
;;;	������ resume ��������������������������������������������������
